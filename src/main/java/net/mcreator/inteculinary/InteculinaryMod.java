 ...
 *
 */
package net.mcreator.inteculinary;
...
@Mod("inteculinary")
public class InteculinaryMod {
	public static final Logger LOGGER = LogManager.getLogger(InteculinaryMod.class);
	public static final String MODID = "inteculinary";
